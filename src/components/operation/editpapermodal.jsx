...
const modal = ({
  ...
  const {
    _journallist, _fieldlist, user_id, editmodalVisible, edititem, modalType,
  } = search;
  ...
  function handleOk() {
    validateFields((errors) => {
      ...
      const strdata = {
        ...
        paper_author_id:user_id,
        paper_id:edititem.paper_id,
      };
      dispatch({
        type: 'search/editPaper',
        payload: strdata,
      });
      dispatch({
      ...
      <Form horizontal>
        <FormItem label="标题：" hasFeedback {...formItemLayout}>
          {getFieldDecorator('paper_title', {
            ...
            initialValue:edititem.paper_title,
          })(<Input />)}
        </FormItem>
        <FormItem label="发表年份：" hasFeedback {...formItemLayout}>
          {getFieldDecorator('paper_published_year', {
            ...
            initialValue:edititem.paper_published_year,
        ...
        <FormItem label="发表期刊：" hasFeedback {...formItemLayout}>
          {getFieldDecorator('paper_published_journal_id', {
            ...
            initialValue:edititem.paper_published_journal_id,
          })(
        ...
        <FormItem label="论文领域：" hasFeedback {...formItemLayout}>
          {getFieldDecorator('paper_field_id', {
            ...
            initialValue:edititem.paper_field_id,
          })(
            <Select placeholder="请选择"
        ...
        <FormItem label="链接：" hasFeedback {...formItemLayout}>
          {getFieldDecorator('paper_link', {
            ...
            initialValue:edititem.paper_link,
          })(<Input />)}
        </FormItem>
      </Form>
    </Modal>
